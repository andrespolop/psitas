...
<body>
	<div class="wrap">
		...
		<div class="secciones">
			<article id="tab1">
			<center><a href="tagregar.php" class="btn">AGREGAR</a></center>
				<div class="container-table"> 
					...
					<div class="table__item"><a href="teliminar.php?id=<?php echo $row["id"]; ?>" class="btne">-</a></div>
			...
			<article id="tab2">
				<div class="container-table"> 
					...
					<div class="table__item"><a href="peliminar.php?id=<?php echo $row["id"]; ?>" class="btne">-</a></div>
					<?php } ?>
				</div>
